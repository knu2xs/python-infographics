...
if importlib.util.find_spec("infographics") is None:
    src_dir = find_pkg_source("infographics")
...
class Toolbox:
    def __init__(self):
        ...
        self.label = "infographics"
        self.alias = "infographics"
...
class CreateDataDirectory:
    ...
    def execute(self, parameters, messages):
        ...
        infographics.utils.configure_logging("INFO")
        ...
        infographics.utils.build_data_resources(dir_data)
